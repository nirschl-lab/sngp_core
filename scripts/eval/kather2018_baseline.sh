...
WANDB_GROUP="test_kather2018_baseline_resnet18"
EXPERIMENT_NAME="Test: kather2018_baseline"
ACCELERATOR="gpu"
BATCH_SIZE=2048
N_CLASSES=9
model_name="resnet18"
csv_save_path="csv/final/kather2018_baseline/"

# Define tags as a variable
TAGS="[\"kather_et_al_2018\", \"baseline\", \"test\"]"
DATASET_NAMES=(
